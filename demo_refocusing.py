...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='3d refocusing pulse design'
    )
    parser.add_argument('--b0map',type=int,default=-1,help='which b0 map')
    parser.add_argument('--b1map',type=int,default=-1,help='which b1 map')
    parser.add_argument('--folder',type=str,default='test',help='folder name for results')
    parser.add_argument('--optimization',type=int,default=0,help='optimization')
    parser.add_argument('--evaluation',type=int,default=0,help='evaluation')
